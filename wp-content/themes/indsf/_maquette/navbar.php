	...
	<nav class="navbar navbar-default navbar-menu role="navigation"">
		...
		<div class="collapse navbar-collapse js-navbar-collapse nav-col">
			<ul class="nav navbar-nav nav-menu nav-line">
						...
						<ul class="dropdown-menu mega-dropdown-menu row">
							...
							<li class="col-lg-3 col-md-6">
							  <ul class="header-directeur">
								...
								<li class="divider"></li>
								<p class="text-info">
								<img class="img-thumbnail img-responsive header-directeur-img" src="img/header/tranin.png" alt="photo du directeur"/>
						...
						<ul class="dropdown-menu mega-dropdown-menu row">
							...
							<li class="col-lg-6">
							  <ul class="header-directeur">
								...
								<li class="divider"></li>
								<p class="text-info">
								<img class="img-thumbnail img-responsive header-directeur-img" src="img/header/buttin.png" alt="photo du directeur"/>
						...
						<ul class="dropdown-menu mega-dropdown-menu row">
							...
							<li class="col-lg-3">
							  <ul class="header-directeur">
								...
								<li class="divider"></li>
								<p class="text-info">
								<img class="img-thumbnail img-responsive header-directeur-img" src="img/header/maillard.png" alt="photo du directeur"/>
						...
						<ul class="dropdown-menu mega-dropdown-menu row">
							...
							<li class="col-lg-6">
							  <ul class="header-directeur">
								...
								<li class="divider"></li>
								<p class="text-info">
								<img class="img-thumbnail img-responsive header-directeur-img" src="img/header/Vermeren-bacles.png" alt="photo du directeur"/>
				...
				<!-- SEARCH BAR -->
        		<form class="navbar-form navbar-right nav-form-bottom hidden-sm " role="search">
